/**
 * Profile & goals — DESIGN.md §6.19, ADR-17.
 *
 * Reached from the top bar's `Profile` control. Same page shell as `Onboarding`, reused for
 * editing rather than a distinct settings design. Sections: Identity, Goals, Nutrition
 * targets, Dietary preferences & allergies, Injuries/notes, and a closing explainer — the
 * user-facing statement of the historical-integrity rule ADR-17 enforces structurally
 * (`profile_change` history: changing a target here only affects targets going forward).
 */
        ...
        <div className="w-full max-w-[560px]">
          ...
          {profile.isPending ? (
            ...
            <div className="mt-8 flex flex-col gap-8">
              ...
              <section className="flex flex-col gap-4 border-t border-border pt-6">
                <h2 className="text-dense font-medium text-foreground">
                  Dietary preferences & allergies
                </h2>
                <Field
              ...
              <p className="border-t border-border pt-6 text-meta text-faint">
                Your protein target uses your weight, activity level, and goal. Changing it here
                only affects targets going forward — past days are judged against the target that
                was active then.
              </p>
