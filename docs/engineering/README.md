...
| [replay-architecture.md](replay-architecture.md) | **Pre-implementation** design review for Phase 4 / T8 (replay CLI): the extraction cache, the idempotent resume ledger and why naive resume silently duplicates memories, confidence/canonicalization decisions inherited from TODOS.md, the milestone plan, and the open questions still blocking implementation |
