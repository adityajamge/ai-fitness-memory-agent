...
| Conversation, returning account + fresh thread | `Ask something.` / `Everything you've logged is already in memory — ask about it, or log more.` | `Logo` at 64px, animated |
